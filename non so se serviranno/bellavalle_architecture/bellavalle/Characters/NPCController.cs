...
namespace Bellavalle.Characters
{
    ...
    public class NPCController : MonoBehaviour
    {
        ...
        static readonly int _hashMood    = Animator.StringToHash("Mood");
        ...
        void OnMoodChanged(object data)
        {
            ...
            if (id != npcData.npcId) return;
            animator?.SetFloat(_hashMood, value);
        }
        ...
        void SyncMoodToAnimator()
        {
            if (animator == null || npcData == null) return;
            float mood = GameManager.Instance.GetNpcMood(npcData.npcId);
            animator.SetFloat(_hashMood, mood);
        }
    }
}
